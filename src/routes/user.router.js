...
import { createOneListFavs, deleteOneListFavs, getAllListFavs, getOneListFavs } from "../controllers/user.controller.js";
//import controllers
...
router.route("/api/favs/:id").post(isAuthenticated,deleteOneListFavs);
